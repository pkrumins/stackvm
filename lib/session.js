...
function Session (params) {
    ...
    self.screenshot = function (host, cb) {
        desktops[host].fb.screenshot(cb);
    }

    self.startScreencast = function (host) {
        desktops[host].fb.startScreencast();
    }

    self.stopScreencast = function (host, cb) {
        desktops[host].fb.stopScreencast(cb);
    }
