    ...
    this.start = function () {
        ...
        */
        ...
        rfb.addListener('startnRects', function (rfbVars) {
            if (rfbVars.nRects > 1) {
                rfbVars.pngStack = new PngLib.PngStack(rfbVars.fbWidth, rfbVars.fbHeight);
            }
        })
        rfb.addListener('endnRects', function (rfbVars) {
            if (rfbVars.nRects > 1) {
                ...
                vm.emit('png', {
                    ...
                    width : rfbVars.fbWidth,
                    height : rfbVars.fbHeight,
                    x : 0,
                    y : 0
                });
            }
        ...
        rfb.addListener('raw', function (rfbVars, raw) {
            if (rfbVars.nRects == 1) {
                ...
                rfbVars.pngStack.push(raw.x, raw.y, raw.width, raw.height, raw.fb);
            }
        });
